...
public class CreateOrderTest {
    ...
    //Проверить что можно создать заказ с авторизацией и с ингредиентами
    @Test
    ...
    //Проверить что можно создать заказ без авторизации и с ингредиентами
    @Test
    ...
    //Проверить что нельзя создать заказ с авторизацией и без ингредиентов
    @Test
    ...
    //Проверить что нельзя создать заказ без авторизации и без ингредиентов
    @Test
    ...
    //Проверить что если передан невалидный хеш ингредиента, вернётся код ответа 500
    @Test
